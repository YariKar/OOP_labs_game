        ...
        int Controller::Choose_Level()
        {
            ...
            while(!success)
            {
                ...
                else
                {
                    ...
                    std::cin.ignore();
                    std::system("clear");
                    Tracked_Object::Notify("error","Попытка выбрать несуществующий уровень");
                    std::cout<<"Ошибка ввода. Пожалуйста, выберите уровень повторно. Доступные уровни 1 или 2\n";
                }
            }
            Tracked_Object::Notify("game","Уровень выбран");
            return level;
        }
